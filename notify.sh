...
git remote add github https://$GITHUB_TOKEN@github.com/FEMessage/nuxt-modularize.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/FEMessage/nuxt-modularize/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "nuxt-modularize更新", "text": "@所有人\n# [nuxt-modularize('$version')]('$html_url')\n'$body'"}}'
